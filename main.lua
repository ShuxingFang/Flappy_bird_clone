...
function love.draw()
    ...
    if notPaused == false then
        ...
        love.graphics.draw(pause, VIRTUAL_WIDTH / 2 - 64, VIRTUAL_HEIGHT / 2 - 64)
        love.graphics.setColor(128/255, 128/255, 128/255, 0.3)  -- Gray color with 50% opacity
